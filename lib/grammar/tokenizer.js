...
CodeMirror.defineMode("shex11", function(config, parserConfig) {
  ...
  var LANG_STRING_LITERAL1 ="'([^'\\\\\\\n\\\r] |"+ ECHAR+"|"+UCHAR+")*'"+LANGTAG;
  var LANG_STRING_LITERAL2 ="\"([^'\\\\\\\n\\\r] |"+ ECHAR+"|"+UCHAR+")*\""+LANGTAG;
  var LANG_STRING_LITERAL_LONG1 ="'''(('|'')?([^\\\\'\\]|"+ECHAR+"|"+UCHAR+"))*'''" + LANGTAG;
  var LANG_STRING_LITERAL_LONG1 ="\"\"\"(('|'')?([^\\\\'\\]|"+ECHAR+"|"+UCHAR+"))*\"\"\"" + LANGTAG;
