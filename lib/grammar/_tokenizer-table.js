module.exports = {table:
{
  ...
  "?shapeOrRef" : {
     ...
     "$": []}, 
  "?tripleExpression" : {
     "multiElementOneOf": ["tripleExpression"], 
     "singleElementGroup": ["tripleExpression"], 
     "multiElementGroup": ["tripleExpression"], 
     "}": []}, 
  "[AND,inlineShapeNot]" : {
  ...
  "groupTripleExpr" : {
     "singleElementGroup": ["or([singleElementGroup,multiElementGroup])"], 
     "multiElementGroup": ["or([singleElementGroup,multiElementGroup])"]}, 
  "importDecl" : {
  ...
  "oneOfTripleExpr" : {
     "singleElementGroup": ["groupTripleExpr"], 
     "multiElementGroup": ["groupTripleExpr"], 
  ...
  "stringLength" : {
     ...
     "MAXLENGTH": ["MAXLENGTH"]}, 
  "tripleExpression" : {
     "multiElementOneOf": ["oneOfTripleExpr"], 
     "singleElementGroup": ["oneOfTripleExpr"], 
     "multiElementGroup": ["oneOfTripleExpr"]}, 
  "xsFacet" : {
