module.exports = {table:
{
  ...
  "*valueSetValue" : {
     ...
     "-": ["valueSetValue","*valueSetValue"], 
     "IRIREF": ["valueSetValue","*valueSetValue"], 
  ...
  "?[or([notStartAction,startActions]),*statement]" : {
     "%": ["[or([notStartAction,startActions]),*statement]"], 
     "IRIREF": ["[or([notStartAction,startActions]),*statement]"], 
  ...
  "booleanLiteral" : {
     ...
     "false": ["or([true,false])"]}, 
  "bracketedTripleExpr" : {
     "(": ["(","tripleExpression",")","?cardinality","*anotation","semanticActions"]}, 
  "cardinality" : {
     "*": ["*"], 
     "+": ["+"], 
     "?": ["?"], 
  ...
  "groupTripleExpr" : {
     "$": ["or([singleElementGroup,multiElementGroup])"], 
     "(": ["or([singleElementGroup,multiElementGroup])"], 
     "&": ["or([singleElementGroup,multiElementGroup])"], 
     "RDF_TYPE": ["or([singleElementGroup,multiElementGroup])"], 
     "^": ["or([singleElementGroup,multiElementGroup])"], 
     "IRIREF": ["or([singleElementGroup,multiElementGroup])"], 
     "PNAME_LN": ["or([singleElementGroup,multiElementGroup])"], 
     "PNAME_NS": ["or([singleElementGroup,multiElementGroup])"]}, 
  "importDecl" : {
  ...
  "inlineShapeAnd" : {
     ...
     "IRIREF": ["inlineShapeNot","*[AND,inlineShapeNot]"], 
  ...
  "inlineShapeOr" : {
     ...
     "IRIREF": ["inlineShapeAnd","*[OR,inlineShapeAnd]"], 
  ...
  "iri" : {
     "IRIREF": ["or([IRIREF,prefixedName])"], 
     "PNAME_LN": ["or([IRIREF,prefixedName])"], 
     "PNAME_NS": ["or([IRIREF,prefixedName])"]}, 
  "iriRange" : {
     "IRIREF": ["iri","?[~,*exclusion]"], 
  ...
  "multiElementGroup" : {
     ...
     "^": ["unaryTripleExpr","+[;,unaryTripleExpr]","?;"], 
     "IRIREF": ["unaryTripleExpr","+[;,unaryTripleExpr]","?;"], 
  ...
  "multiElementOneOf" : {
     ...
     "(": ["groupTripleExpr","+[|,groupTripleExpr]"], 
     "&": ["groupTripleExpr","+[|,groupTripleExpr]"], 
     "RDF_TYPE": ["groupTripleExpr","+[|,groupTripleExpr]"], 
     "^": ["groupTripleExpr","+[|,groupTripleExpr]"], 
     "IRIREF": ["groupTripleExpr","+[|,groupTripleExpr]"], 
     "PNAME_LN": ["groupTripleExpr","+[|,groupTripleExpr]"], 
     "PNAME_NS": ["groupTripleExpr","+[|,groupTripleExpr]"]}, 
  "nonLitNodeConstraint" : {
  ...
  "notStartAction" : {
     "IRIREF": ["or([start,shapeExprDecl])"], 
     "BLANK_NODE_LABEL": ["or([start,shapeExprDecl])"], 
     "PNAME_LN": ["or([start,shapeExprDecl])"], 
     "PNAME_NS": ["or([start,shapeExprDecl])"]}, 
  "numericFacet" : {
  ...
  "oneOfTripleExpr" : {
     "$": ["or([groupTripleExpr,multiElementOneOf])"], 
     "(": ["or([groupTripleExpr,multiElementOneOf])"], 
     "&": ["or([groupTripleExpr,multiElementOneOf])"], 
     "RDF_TYPE": ["or([groupTripleExpr,multiElementOneOf])"], 
     "^": ["or([groupTripleExpr,multiElementOneOf])"], 
     "IRIREF": ["or([groupTripleExpr,multiElementOneOf])"], 
     "PNAME_LN": ["or([groupTripleExpr,multiElementOneOf])"], 
     "PNAME_NS": ["or([groupTripleExpr,multiElementOneOf])"]}, 
  "or([CODE,%])" : {
     "CODE": ["CODE"], 
     "%": ["%"]}, 
  "or([IRIREF,prefixedName])" : {
     "IRIREF": ["IRIREF"], 
  ...
  "or([groupTripleExpr,multiElementOneOf])" : {
     ...
     "^": ["groupTripleExpr"], 
     "IRIREF": ["groupTripleExpr"], 
     "PNAME_LN": ["groupTripleExpr"], 
     "PNAME_NS": ["groupTripleExpr"], 
     "$": ["multiElementOneOf"], 
     "(": ["multiElementOneOf"], 
     "&": ["multiElementOneOf"], 
     "RDF_TYPE": ["multiElementOneOf"], 
     "^": ["multiElementOneOf"], 
     "IRIREF": ["multiElementOneOf"], 
     "PNAME_LN": ["multiElementOneOf"], 
     "PNAME_NS": ["multiElementOneOf"]}, 
  "or([inlineShapeDefinition,shapeRef])" : {
     "{": ["inlineShapeDefinition"], 
  ...
  "or([singleElementGroup,multiElementGroup])" : {
     ...
     "(": ["singleElementGroup"], 
     "&": ["singleElementGroup"], 
     "RDF_TYPE": ["singleElementGroup"], 
     "^": ["singleElementGroup"], 
     "IRIREF": ["singleElementGroup"], 
     "PNAME_LN": ["singleElementGroup"], 
     "PNAME_NS": ["singleElementGroup"], 
     "$": ["multiElementGroup"], 
     "(": ["multiElementGroup"], 
     "&": ["multiElementGroup"], 
     "RDF_TYPE": ["multiElementGroup"], 
     "^": ["multiElementGroup"], 
     "IRIREF": ["multiElementGroup"], 
     "PNAME_LN": ["multiElementGroup"], 
     "PNAME_NS": ["multiElementGroup"]}, 
  ...
  "shapeAtom" : {
     ...
     ".": ["."]}, 
  "shapeDefinition" : {
     "{": ["*or([extraPropertySet,CLOSED])","{","?tripleExpression","}","*anotation","semanticActions"], 
     "CLOSED": ["*or([extraPropertySet,CLOSED])","{","?tripleExpression","}","*anotation","semanticActions"], 
     "EXTRA": ["*or([extraPropertySet,CLOSED])","{","?tripleExpression","}","*anotation","semanticActions"]}, 
  "shapeExprDecl" : {
     "IRIREF": ["shapeExprLabel","or([shapeExpression,EXTERNAL])"], 
  ...
  "shexDoC" : {
     ...
     "%": ["*directive","?[or([notStartAction,startActions]),*statement]","$"], 
     "IRIREF": ["*directive","?[or([notStartAction,startActions]),*statement]","$"], 
  ...
  "statement" : {
     ...
     "IRIREF": ["or([directive,notStartAction])"], 
  ...
  "stringLength" : {
     ...
     "MAXLENGTH": ["MAXLENGTH"]}, 
  "tripleConstraint" : {
     "RDF_TYPE": ["?senseFlags","predicate","inlineShapeExpression","?cardinality","*anotation","semanticActions"], 
     "IRIREF": ["?senseFlags","predicate","inlineShapeExpression","?cardinality","*anotation","semanticActions"], 
     "PNAME_LN": ["?senseFlags","predicate","inlineShapeExpression","?cardinality","*anotation","semanticActions"], 
     "PNAME_NS": ["?senseFlags","predicate","inlineShapeExpression","?cardinality","*anotation","semanticActions"], 
     "^": ["?senseFlags","predicate","inlineShapeExpression","?cardinality","*anotation","semanticActions"]}, 
  "tripleExprLabel" : {
     "IRIREF": ["or([iri,blankNode])"], 
     "BLANK_NODE_LABEL": ["or([iri,blankNode])"], 
     "PNAME_LN": ["or([iri,blankNode])"], 
  ...
  "unaryTripleExpr" : {
     ...
     "^": ["?[$,tripleExprLabel]","or([tripleConstraint,bracketedTripleExpr])"], 
     "IRIREF": ["?[$,tripleExprLabel]","or([tripleConstraint,bracketedTripleExpr])"], 
