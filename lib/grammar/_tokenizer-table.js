module.exports = {table:
{
  ...
  "?[or([notStartAction,startActions]),*statement]" : {
     "%": ["[or([notStartAction,startActions]),*statement]"], 
     "blankNode": ["[or([notStartAction,startActions]),*statement]"], 
  ...
  "notStartAction" : {
     "blankNode": ["or([start,shapeExprDecl])"], 
  ...
  "shapeExprDecl" : {
     "blankNode": ["shapeExprLabel","or([shapeExpression,EXTERNAL])"], 
  ...
  "shexDoC" : {
     ...
     "%": ["*directive","?[or([notStartAction,startActions]),*statement]","$"], 
     "blankNode": ["*directive","?[or([notStartAction,startActions]),*statement]","$"], 
  ...
  "statement" : {
     ...
     "blankNode": ["or([directive,notStartAction])"], 
  ...
  "tripleConstraint" : {
     ...
     "IRIREF": ["?senseFlags","predicate","inlineShapeExpression","?cardinality","*annotation","semanticActions"], 
